<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="firstname" value="{{ __('ชื่อจริง') }}" />
        ...
        <!-- Lastname -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="lastname" value="{{ __('นามสกุล') }}" />
        ...
        <!-- Gender -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="gender" value="{{ __('เพศ') }}" />
            <label >
        ...
        <!-- Department -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="department" value="{{ __('ตำแหน่ง') }}" />
        ...
        <!-- Phone -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="phone" value="{{ __('เบอร์โทร') }}" />
        ...
        <!-- Address -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="address" value="{{ __('ที่อยู่') }}" />
