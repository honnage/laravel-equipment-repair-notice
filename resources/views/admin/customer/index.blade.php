                        ...
                        <div class="card-body">
                            <form action="{{route('addCustomer')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="firstname" placeholder="กรุณาป้อน ชื่อจริง">
                                </div>
                                @error('firstname')
                                    <div class="my-2">
                                ...
                                <div class="form-group my-2">
                                    ...
                                    <select class="form-control" name="gender">
                                        <option value="" style="text-align: center">----- กรุณาเลือกเพศ -----</option>
                                ...
                                <div class="form-group my-2">
                                    ...
                                    <input type="text" class="form-control" name="email" placeholder="กรุณาป้อน อีเมล">
                                </div>
                                @error('email')
                                    <div class="my-2">
                                        <span class="text-danger">{{$message}}</span>
                                ...
                                <div class="form-group my-2">
                                    ...
                                    <input type="text" class="form-control" name="phone" placeholder="กรุณาป้อน เบอร์โทร">
                                </div>
                                @error('phone')
                                    <div class="my-2">
                                        <span class="text-danger">{{$message}}</span>
                                ...
                                <div class="form-group my-2">
                                    ...
                                    <input type="text" class="form-control" name="address" placeholder="กรุณาป้อน ที่อยู่">
                                </div>
                                @error('address')
                                    <div class="my-2">
                                        <span class="text-danger">{{$message}}</span>
                                ...
                                <center>
                                    ...
                                    <input type="submit" value="บันทึก" class="btn btn-success col-sm-5">
                                </center>
                            </form>
                        </div>
                    </div>
