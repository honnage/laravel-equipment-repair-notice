    ...
    <div class="py-12">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header" style="font-size: 24px;">แบบฟอร์ม ลูกค้า</div>
                        <div class="card-body">
                            <form action="{{url('/customer/update/'.$customer->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="firstname">ชื่อจริง</label>
                                    <input type="text" class="form-control" name="firstname" placeholder="กรุณาป้อน ชื่อจริง" value="{{$customer->firstname}}">
                                </div>
                                @error('firstname')
                                    <div class="my-2">
                                ...
                                <div class="form-group my-2">
                                    ...
                                    <input type="text" class="form-control" name="lastname" placeholder="กรุณาป้อน นามสกุล" value="{{$customer->lastname}}">
                                </div>
                                @error('lastname')
                                    <div class="my-2">
                                        <span class="text-danger">{{$message}}</span>
                                ...
                                <div class="form-group my-2">
                                    ...
                                    <select class="form-control" name="gender">
                                        @if ( $customer->gender == "F" )
                                            <option value="F">เพศชาย</option>
                                            <option value="M">เพศหญิง</option>
                                        @else
                                            <option value="M">เพศหญิง</option>
                                            <option value="F">เพศชาย</option>
                                        @endif
                                ...
                                <div class="form-group my-2">
                                    ...
                                    <input type="text" class="form-control" name="email"placeholder="กรุณาป้อน อีเมล" value="{{$customer->email}}">
                                </div>
                                @error('email')
                                    <div class="my-2">
                                        <span class="text-danger">{{$message}}</span>
                                ...
                                <div class="form-group my-2">
                                    ...
                                    <input type="text" class="form-control" name="phone" placeholder="กรุณาป้อน เบอร์โทร" value="{{$customer->phone}}">
                                </div>
                                @error('phone')
                                    <div class="my-2">
                                        <span class="text-danger">{{$message}}</span>
                                ...
                                <div class="form-group my-2">
                                    ...
                                    <input type="text" class="form-control" name="address" placeholder="กรุณาป้อน ที่อยู่" value="{{$customer->address}}">
                                </div>
                                @error('address')
                                    <div class="my-2">
                                        <span class="text-danger">{{$message}}</span>
                                ...
                                <br>
                                <center>
                                    <a href="{{ route('customer') }}" class="btn btn-secondary" type="reset">ยกเลิก</a> &nbsp;
